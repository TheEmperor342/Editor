...
################################################################################
## Form generated from reading UI file 'mainDkgXhw.ui'
##
...
"")
        ...
        icon = QIcon()
        icon.addFile(u":/Icons/img/icons/cil-media-play.png", QSize(), QIcon.Normal, QIcon.Off)
        self.runFileBtn.setIcon(icon)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/Icons/img/icons/cil-folder-open.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Icons/img/icons/cil-notes.png", QSize(), QIcon.Normal, QIcon.Off)
        self.saveAsBtn.setIcon(icon2)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/Icons/img/icons/cil-save.png", QSize(), QIcon.Normal, QIcon.Off)
        self.saveFileBtn.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/Icons/img/icons/cil-window-minimize.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/Icons/img/icons/cil-window-maximize.png", QSize(), QIcon.Normal, QIcon.Off)
        self.maxBtn.setIcon(icon5)
...
"}")
        icon6 = QIcon()
        icon6.addFile(u":/Icons/img/icons/cil-x.png", QSize(), QIcon.Normal, QIcon.Off)
